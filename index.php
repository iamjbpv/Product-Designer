...
<head>
    ...
    <title>Product Desinger By JBPV</title>
    <meta name="description" content="PRODUCT DESIGNER BY JB VILLAMAYOR powered by jQuery">
                                            ...
                                            <div class="box" style="height:500px;padding:15px;overflow-y:scroll;">
                                                <div class="col-md-12">
                                                    <div class="custom_font">
                                                        ...
                                                        <textarea id="custom_text" rows="5" class="form-control" placeholder="Create Your Custom Text..."></textarea>
                                                        <hr>
